...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('toolsAdmin/css/pages/authentication.css') }}">
    <!-- END: Page CSS-->

    <!-- BEGIN: Custom CSS-->
    <link rel="stylesheet" type="text/css" href="{{ asset('toolsAdmin/assets/css/style.css') }}">
    <!-- END: Custom CSS-->
...
<body class="vertical-layout vertical-menu-modern 1-column  navbar-floating footer-static bg-full-screen-image  blank-page blank-page" data-open="click" data-menu="vertical-menu-modern" data-col="1-column">
                        ...
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                    <img src="{{ asset('toolsAdmin/images/pages/login.png')}}" alt="branding logo">
                                </div>
                                <div class="col-lg-6 col-12 p-0">
                                    <div class="card rounded-0 mb-0 px-2">
                                        ...
                                        <p class="px-2">Selamat Datang, Silahkan Login Utuk Akses Selanjutnya</p>
    ...
    <!-- BEGIN: Vendor JS-->
    <script src="{{ asset('toolsAdmin/vendors/js/vendors.min.js') }}"></script>
    <!-- BEGIN Vendor JS-->
    ...
    <!-- BEGIN: Theme JS-->
    <script src="{{ asset('toolsAdmin/js/core/app-menu.js') }}"></script>
    <script src="{{ asset('toolsAdmin/js/core/app.js') }}"></script>
    <script src="{{ asset('toolsAdmin/js/scripts/components.js') }}"></script>
    <!-- END: Theme JS-->
