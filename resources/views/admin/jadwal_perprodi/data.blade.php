...
<table class="table zero-configuration">
    <thead>
        ...
        <tr class="hilang">
            <th>JADWAL KULIAH @foreach ($jadwal->keyBy('id_prodi') as $item) {{ $item->prodi->nm_prodi }} @endforeach</th>
        </tr>
        <tr class="hilang">
            <th>SEMESTER @foreach ($jadwal->keyBy('semester') as $item) {{ $item->semester }} @endforeach</th>
        </tr>
        <tr class="hilang">
            <th></th>
        </tr>
