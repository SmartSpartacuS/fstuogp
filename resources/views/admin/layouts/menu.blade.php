    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="@yield('Dashboard')"><a href="{{ route('admin') }}"><i class="feather icon-home"></i><span class="menu-title" data-i18n="Dashboard">Dashboard</span></a>
                </li>
                </li>
                <li class="@yield('Ruang') nav-item"><a href="{{ route('ruang.index') }}"><i class="feather icon-check-square"></i><span class="menu-title" data-i18n="Todo">Ruang</span></a>
                </li>
                <li class="@yield('Matkul') nav-item"><a href="{{ route('matkul.index') }}"><i class="feather icon-mail"></i><span class="menu-title" data-i18n="Email">Mata Kuliah</span></a>
                </li>
                ...
                <li class=" nav-item"><a href="#"><i class="feather icon-user"></i><span class="menu-title" data-i18n="Ecommerce">Mahasiswa</span></a>
                    <ul class="menu-content">
                        ...
                        <li id="mhs{{ $item->id }}" class="" >
                            <a href="{{ route('mhs.show',$item->id) }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="mhs">{{ $item->nm_prodi }}</span></a>
                        @endforeach
                    </ul>
                </li>
                <li class=" nav-item"><a href="#"><i class="feather icon-shopping-cart"></i><span class="menu-title" data-i18n="Ecommerce">Jadwal</span></a>
                    <ul class="menu-content">
                        @foreach ($allProdi as $item) 
                        <li id="jadwal{{ $item->id }}" class="" >
                            <a href="{{ route('jadwal.show',$item->id) }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="jadwal">{{ $item->nm_prodi }}</span></a>
                        @endforeach
                    </ul>
                </li>
                <li class=" nav-item"><a href="#"><i class="feather icon-shopping-cart"></i><span class="menu-title" data-i18n="Ecommerce">Kelas</span></a>
                    <ul class="menu-content">
                        @foreach ($allProdi as $item) 
                        <li id="kelas{{ $item->id }}" class="" >
                            <a href="{{ route('kelas.show',$item->id) }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="kelas">{{ $item->nm_prodi }}</span></a>
                        @endforeach
                    </ul>
                </li>
                ...
                <li id="#linkMenuTable" class=" nav-item"><a href="form-layout.html"><i class="feather icon-box"></i><span class="menu-title" data-i18n="Form Layout">Form Layout</span></a>
                </li>
