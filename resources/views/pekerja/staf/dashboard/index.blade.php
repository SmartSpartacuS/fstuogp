...
@section('js')
<script src="{{ asset('toolspekerja/plugins/Chart.js/Chart.min.js') }}"></script>
<!-- Vector map JavaScript -->
<script src="{{ asset('toolspekerja/plugins/vectormap/jquery-jvectormap-2.0.2.min.js') }}"></script>
<script src="{{ asset('toolspekerja/plugins/vectormap/jquery-jvectormap-world-mill-en.js') }}"></script>
<!-- Easy Pie Chart JS -->
<script src="{{ asset('toolspekerja/plugins/jquery.easy-pie-chart/jquery.easypiechart.min.js') }}"></script>
<!-- Sparkline JS -->
<script src="{{ asset('toolspekerja/plugins/sparkline-charts/jquery.sparkline.min.js') }}"></script>
<script src="{{ asset('toolspekerja/plugins/jquery-knob/excanvas.js') }}"></script>
<script src="{{ asset('toolspekerja/plugins/jquery-knob/jquery.knob.js') }}"></script>
...
<!-- Index js -->
<script src="{{ asset('toolspekerja/js/index.js') }}"></script>
@endsection